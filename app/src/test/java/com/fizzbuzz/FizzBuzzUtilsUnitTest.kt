...
class FizzBuzzUtilsUnitTest {
    ...
    fun addition_isCorrect() {
        ...
        assertEquals(
            "1",
            FizzBuzzUtils.generateFitBuzzString(1, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "2",
            FizzBuzzUtils.generateFitBuzzString(2, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "fizz",
            FizzBuzzUtils.generateFitBuzzString(3, FizzBuzzUtils.defaultFitBuzz())
        )
        assertNotEquals(
            "3",
            FizzBuzzUtils.generateFitBuzzString(3, FizzBuzzUtils.defaultFitBuzz())
        ...
        assertEquals(
            "4",
            FizzBuzzUtils.generateFitBuzzString(4, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "buzz",
            FizzBuzzUtils.generateFitBuzzString(10, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "fizz",
            FizzBuzzUtils.generateFitBuzzString(6, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "fizzbuzz",
            FizzBuzzUtils.generateFitBuzzString(15, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "fizz",
            FizzBuzzUtils.generateFitBuzzString(27, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "fizzbuzz",
            FizzBuzzUtils.generateFitBuzzString(30, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "buzz",
            FizzBuzzUtils.generateFitBuzzString(35, FizzBuzzUtils.defaultFitBuzz())
        )
        assertEquals(
            "fizzbuzz",
            FizzBuzzUtils.generateFitBuzzString(45, FizzBuzzUtils.defaultFitBuzz())
        )

        val darkVardor = FizzbuzzEntity(2, 2, 300, "dark", " vador")
        ...
        val testmeta = FizzbuzzEntity(2, 3, 300, "test", "meta")
